pageextension 80180 ImportNotes extends "Sales Quotes"
//Core code from YUN ZHU github handle yzhums
{
    actions
    {
        addfirst(processing)
    ...
    begin
        ...
        for RowNo := 2 to MaxRowNo do begin
            ...
            Item.Get(GetValueAtCell(RowNo, 2));
    ...
    // local procedure ClearAllLinksAndNotes(Item: Record "Sales Header")
    // var
    //     RecordLink: Record "Record Link";
    // begin
    //     Item.Reset();
